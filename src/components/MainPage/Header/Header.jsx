          ...
          >
            <div className="sm:flex sm:justify-between">
              <div className="uppercase bold w-1/2 z-10 relative mt-[18px]">
                <p
                  className={`${theme === "light" ? "text-grey" : "text-darkModeText"} text-[32px] sm:text-[57.6px] sm:leading-[70px]`}
                >
                  szybka <br /> pożyczka <br /> online
                </p>
                <p className="text-[27px] sm:text-[49px] underline text-blue -rotate-[7deg] absolute top-[130px] sm:top-[195px] left-[10px] sm:left-[15px] w-[200px] sm:w-[300px]">
                  w 15 minut
                </p>
              </div>
